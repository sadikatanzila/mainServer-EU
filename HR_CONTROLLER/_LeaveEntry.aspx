<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_LeaveEntry.aspx.cs" Inherits="HR_CONTROLLER_LeaveEntry" %>
...
&nbsp;&nbsp;
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GridView_LeaveBalance" runat="server" AutoGenerateColumns="False" ShowFooter="false"
                                            BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" DataKeyNames="LEAVE_INFO_ID"
                                            CellPadding="4" Width="80%" OnRowDataBound="GridView_LeaveBalance_RowDataBound" 
                                OnRowDeleting="GridView_LeaveBalance_RowDeleting">
 ...
 <asp:TemplateField HeaderText="Leave ID" ItemStyle-Width="15%" Visible="false"> 
                                <ItemTemplate>
                                   <asp:Label ID="lblLEAVE_INFO_ID" runat="server" Text='<%# Bind("LEAVE_INFO_ID") %>'></asp:Label>                                         
                                </ItemTemplate>
  ...
  <asp:TemplateField HeaderText="Taken" ItemStyle-Width="25%"> 
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgButton" runat="server" ImageUrl="../images/Deleteicon.png" CommandName="Delete"
                                    Text="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure to Cancel Leave?')" /></ItemTemplate>
                        ...
                        <td style="width:30%">
                           ...
                           <asp:TemplateField HeaderText="Remaining Balance" ItemStyle-Width="25%"> 
                                <ItemTemplate>
                                    <asp:Label ID="lblBalance" runat="server" Text='<%# Bind("REMAINING_BALANCE") %>'></asp:Label>                                               
                                </ItemTemplate>
