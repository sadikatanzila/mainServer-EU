<%@ Page Language="C#" MasterPageFile="~/student/academics/academics_masterPage.master" AutoEventWireup="true" CodeFile="_completedCourses.aspx.cs" Inherits="student_academics_completedCourses" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_tracker" Runat="Server">
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Academics&gt;Completed Courses</span></td>
        </tr>
    </table>
</asp:Content>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="539">
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="505">
                            <p align="center">
                                <b><font color="#ffa500" face="Arial" size="2">Completed Courses</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="505">
