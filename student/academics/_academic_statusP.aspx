<%@ Page Language="C#" MasterPageFile="~/student/academics/academics_masterPage.master" 
AutoEventWireup="true" CodeFile="_academic_statusP.aspx.cs" Inherits="student_academics_academic_statusP"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_tracker" Runat="Server">
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Academics&gt;Academic Status</span></td>
        </tr>
    </table>
</asp:Content>
