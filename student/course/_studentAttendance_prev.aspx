<%@ Page Title="Attendance" Language="C#" MasterPageFile="~/student/course/course_masterPage.master" AutoEventWireup="true" CodeFile="_studentAttendance_prev.aspx.cs" Inherits="student_studentAttendance_prev" %>
                            ...
                            <asp:Label ID="lbl_semester" runat="server" Font-Bold="True" Text="Label"></asp:Label>&nbsp;<br />
                                <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="taken_class" HeaderText="Taken Class">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                       ...
                                       <asp:BoundField DataField="Persentance" HeaderText="% of Presence">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
