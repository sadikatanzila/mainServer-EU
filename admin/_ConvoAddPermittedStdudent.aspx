<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_ConvoAddPermittedStdudent.aspx.cs"
 Inherits="admin_ConvoAddPermittedStdudent" Title="Permitted Student in Convocation" %>
...
<td style="width: 500px">
  <asp:TextBox ID="txtStudentID" runat="server" Width="150px" AutoPostBack="true" OnTextChanged="txtStudentID_TextChanged"></asp:TextBox> &nbsp; &nbsp; &nbsp; &nbsp;
  <asp:TextBox ID="lblStudentName" runat="server" Width="200px" OnTextChanged="txtStudentID_TextChanged" ReadOnly="true"></asp:TextBox>
...
<div style="width:80%; text-align: left; margin-left:25px">
    <asp:Label ID="Label1" runat="server" Text="Permitted Student List for Convocation (after Date Expiration)"></asp:Label>
<br />
...
<asp:GridView ID="GridView_student" runat="server" AutoGenerateColumns="False"
                        ...
                        <HeaderStyle HorizontalAlign="Center" />
                                                ...
                                                <asp:BoundField DataField="SNAME" HeaderText="Name" />
                                                  <asp:BoundField DataField="YEAR" HeaderText="Convo Year" />
                                            </Columns>
