<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_accounceClearence.aspx.cs" Inherits="admin_accounceClearence"  %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Accounce Clearence</font></b></p>
                                ...
                                <tr>
                                    <td class="header" style="vertical-align: top; background-color: #ffffff; text-align: left">
                                        ...
                                        <span style="font-size: 10pt"><span style="color: #000000">
                                                    ...
                                                    <td style="width: auto; height: auto">
                                        <span style="font-size: 10pt"><span style="color: #000000">
                                                        <asp:TextBox ID="txt_year" runat="server" MaxLength="4" Width="123px"></asp:TextBox>
                                        </span></span>
                                                    </td>
                                                    <td style="width: 35px; height: 22px">
                                                        &nbsp;</td>
