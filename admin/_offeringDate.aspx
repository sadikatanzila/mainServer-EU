                                ...
                                <tr>
                                    <td class="header" style="height: 10px; background-color: #ffffff; text-align: left">
                                        ...
                                        <table id="tbl_dates" runat="server" width="80%">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                     <fieldset style="width: 100%; float: left; border: 1px Solid Black;">
                        <legend id="legend1" style="font-weight: bold" runat="server">Regular Advising</legend>
   ...
   <tr>
        ...
        <tr>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <fieldset style="width: 100%; float: left; border: 1px Solid Black;">
                        <legend id="legend2" style="font-weight: bold" runat="server">With Late Advising Fee</legend>
                                                    <table style="width:95%">
                                                          <tr>
                                                <td>
                                                   Students&#39; Opening Date</td>
                                                <td>
                                                    :</td>
                                                <td>
                                                     <asp:TextBox ID="txt_student_LateFeeOpening" runat="server" Height="15px" Width="150px"  ></asp:TextBox>
                                                    
                                                    <asp:CalendarExtender ID="txt_student_LateFeeOpening_CalendarExtender" runat="server"
                                                         Format="dd-MMM-yyyy" TargetControlID="txt_student_LateFeeOpening"></asp:CalendarExtender>
                                                   </td>
                                                <td>
                                                    &nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                     <asp:TextBox ID="txt_student_LateFeeClosing" runat="server" Height="15px" Width="150px"  ></asp:TextBox>
                                                    
                                                    <asp:CalendarExtender ID="txt_student_LateFeeClosing_CalendarExtender" runat="server"
                                                         Format="dd-MMM-yyyy" TargetControlID="txt_student_LateFeeClosing"></asp:CalendarExtender>
                                                   </td>
                                                <td>
                                                    &nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <fieldset style="width: 100%; float: left; border: 1px Solid Black;">
                        <legend id="legend4" style="font-weight: bold" runat="server">Course Add & Drop</legend>
<table style="width:95%">
        ...
        <tr>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                      <fieldset style="width: 100%; float: left; border: 1px Solid Black;">
                        <legend id="legend3" style="font-weight: bold" runat="server">Late Advising with Special Permission of Registrar Office</legend>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                     <asp:TextBox ID="txt_student_ReOpening" runat="server" Height="15px" Width="150px"  ></asp:TextBox>
                                                    
                                                    <asp:CalendarExtender ID="txt_student_ReOpening_CalendarExtender" runat="server"
                                                         Format="dd-MMM-yyyy" TargetControlID="txt_student_ReOpening"></asp:CalendarExtender>
                                                   </td>
                                                <td>
                                                    &nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                     <asp:TextBox ID="txt_student_Reclosing" runat="server" Height="15px" Width="150px"  ></asp:TextBox>
                                                    
                                                    <asp:CalendarExtender ID="txt_student_Reclosing_CalendarExtender" runat="server"
                                                         Format="dd-MMM-yyyy" TargetControlID="txt_student_Reclosing"></asp:CalendarExtender>
                                                   </td>
                                                <td>
                                                    &nbsp;</td>
                                            </tr>
