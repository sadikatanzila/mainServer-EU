<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_offeringDatePrev.aspx.cs" Inherits="admin_offeringDatePrev" %>
                                    ...
                                    <td class="header" style="height: 10px; background-color: #ffffff; text-align: left">
                                        ...
                                        <table id="tbl_dates" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_teacher_re_opening" runat="server" ReadOnly="True"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_teacherReOpening" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_teacher_re_closing" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_teacherReClosing" runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    &nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                    <asp:TextBox ID="txt_FinalAdmit_opening" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_FinalAdmit_opening" 
                                                        runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                    <asp:TextBox ID="txt_FinalAdmit_closing" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_FinalAdmit_closing" 
                                                        runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                    <asp:TextBox ID="txt_MidAdmit_opening" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_MidAdmit_opening" 
                                                        runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                    <asp:TextBox ID="txt_MidAdmit_closing" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                <td>
                                                    <img src="../admin/images/calender.jpg" id="btn_MidAdmit_closing" 
                                                        runat="server" /></td>
                                            </tr>
                                            <tr>
                                                <td>
