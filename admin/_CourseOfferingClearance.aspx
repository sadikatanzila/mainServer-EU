<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_CourseOfferingClearance.aspx.cs" Inherits="admin_CourseOfferingClearance" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Course Offering Clearence</font></b> <hr />
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" style="vertical-align: top; text-align: left" width="100%">
                            <table border="0" style="width: 100%">
                                ...
                                <tr>
                                    <td class="header" style="vertical-align: top; background-color: #ffffff; text-align: left">
                                        <asp:Button ID="btn_cleared" runat="server" OnClick="btn_cleared_Click" Text="Cleared" /></td>
                                </tr>
                            </table>
                        </td>
