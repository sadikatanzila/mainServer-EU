<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_teacheractiveInactive.aspx.cs" Inherits="admin_teacheractiveInactive"  %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Teacher List</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td  class="k" height="1" width="100%">
                                    ...
                                    <td class="header" style="height: 10px; background-color: #ffffff; text-align: left">
                                        ...
                                        <asp:GridView ID="GridView_studentList" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField DataNavigateUrlFields="STAFF_ID" DataNavigateUrlFormatString="~/admin/_add_teacher.aspx?ids={0}"
                                                    DataTextField="STAFF_ID" HeaderText="ID" NavigateUrl="~/admin/_add_teacher.aspx" />
