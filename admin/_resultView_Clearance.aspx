<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_resultView_Clearance.aspx.cs" Inherits="admin_resultView_Clearance" Title="Eastern University Web Portal  " %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Result View Clearence</font></b>
                                        ...
                                        <asp:GridView ID="GridView_student" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:CheckBoxField HeaderText="Is Cleared" DataField="acStatus" >
                                                 ...
                                                 <asp:CheckBoxField HeaderText="Account Clearance" DataField="AccountPayment" >
                                                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                                                </asp:CheckBoxField>
                                                  <asp:CheckBoxField HeaderText="Is Evaluted" DataField="evStatus" >
                                                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                                                </asp:CheckBoxField>
                                            </Columns>
