<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_messageList.aspx.cs" Inherits="admin_messageList" Title="Untitled Page" %>
    ...
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Message&gt; Message List</span></td>
        </tr>
    </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Message List</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td  class="k" height="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff"  style="vertical-align: top; text-align:left"   width="100%">
                            <table border="0" style="width: 100%">
                                ...
                                <tr>
                                    <td class="header" style="vertical-align:top; background-color: #ffffff; text-align: left">
                            <asp:GridView ID="GridView_messageList" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="MESSAGE_ID" DataNavigateUrlFormatString="~/admin/_newMessage.aspx?nid={0}"
                                        HeaderText="Title" NavigateUrl="~/admin/_newMessage.aspx" DataTextField="TITLE" />
                                    ...
                                    <asp:TemplateField HeaderText="Student Roll" > 
                                        <ItemTemplate>
                                            <asp:Label ID="RECIVERSTUDENT_ID" runat="server" Text='<%# Bind("RECIVERSTUDENT_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                     <asp:TemplateField HeaderText="Student Batch" > 
                                        <ItemTemplate>
                                            <asp:Label ID="BATCHID" runat="server" Text='<%# Bind("BATCHID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                 
                                  <asp:TemplateField HeaderText="Student Group" > 
                                        <ItemTemplate>
                                            <asp:Label ID="STDGRPID" runat="server" Text='<%# Bind("STDGRPID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField Visible="False"> 
                                        <ItemTemplate>
                                            <asp:Label ID="MESSAGE_ID" runat="server" Text='<%# Bind("MESSAGE_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
