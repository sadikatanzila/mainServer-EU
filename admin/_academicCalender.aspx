<%@ Page Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_academicCalender.aspx.cs" Inherits="admin_academicCalender"  %>
      ...
      <tr>
          <td>
              <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                  <tr>
                      <td colspan="2" height="24" width="19">
                         </td>
                      <td  class="h" height="22" width="100%">
                          <p align="center">
                              <b><font face="Arial" size="2">Academic Calender</font></b></p>
                           <hr style="color: #333333" />
                      </td>
                      <td align="right" colspan="2" height="24" width="15">
                        </td>
                  </tr>
                  <tr>
                                  ...
                                  <td class="header" style="height: 10px; background-color: #ffffff; text-align: left">
                                      <table id="Table1" runat="server" width="100%">
                                          ...
                                          <tr style="font-size: 8pt; color: #000000">
                                              <td colspan="4">
                                                  ...
                                                  &nbsp;&nbsp; Year
                                                  <asp:TextBox ID="txt_s_year" runat="server" Width="38px" MaxLength="4"></asp:TextBox>
                                                  <asp:Button ID="btn_show" runat="server" OnClick="btn_show_Click" Text="Show" /></td>
                                          </tr>
                                          <tr style="font-size: 8pt; color: #000000">
                                              <td colspan="4">
                                                  <hr />
                                                  <asp:Label ID="lbl_list_message" runat="server" Font-Size="X-Small" ForeColor="Red" Text="Label"></asp:Label></td>
                                          </tr>
                                      </table>
                                      <asp:GridView ID="GridView_list" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                          ...
                                          <Columns>
                                              ...
                                              <asp:HyperLinkField DataTextField="EVENT" HeaderText="Program">
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Add New Academic Calender</font></b></p>
                             <hr style="color: #333333" />
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <table id="tbl_dates" runat="server" width="100%">
                                            ...
                                            <tr style="font-size: 8pt; color: #000000">
                                                ...
                                                <td>
                                                    :</td>
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_year" runat="server" Width="38px" MaxLength="4"></asp:TextBox></td>
                                            </tr>
                                            <tr style="font-size: 8pt; color: #000000">
                                                <td style="width: 93px">
                                                    Program</td>
