<%@ Page Language="C#" MasterPageFile="~/staffs/advisor/MasterPage_advisor.master" AutoEventWireup="true" CodeFile="_courseReAdvisingDetails.aspx.cs" Inherits="staffs_advisor_courseReAdvisingDetails"   %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_tracker" Runat="Server">
 ...
 {
  window.open('_academicStatus.aspx?ids='+sid,'','titlebar=no,toolbar=no,scrollbars,resizable=false,height=640,width=620');
  return false; 
 } 
    ...
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Advisoship &gt; Course Re-Advising Details</span></td>
        </tr>
    ...
    <table id="TABLE1" runat="server" border="0" width="540">
        <tr>
            <td colspan="3" style="text-align: left">
                ...
                <br />
                <asp:Label ID="lbl_Approval" runat="server" ForeColor="Red" Text="" Font-Bold="True"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <table id="tbl_offered_courses" runat="server" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td bgcolor="#6fb1d9" class="k" height="1" width="600">
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="600">
                            <p align="center">
                                <b><font color="#ffa500" face="Arial" size="2">Courses Taken</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="600">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" height="114" style="text-align: left" width="600">
                          ...
                          <HeaderStyle HorizontalAlign="left" />
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <asp:Button ID="btn_final_offering" runat="server" OnClick="btn_final_offering_Click" Width="150px"
                                            Text="Print Approval Courses" Height="30px" /></td>
                                </tr>
                            </table>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td bgcolor="white" height="1" width="600">
                ...
                <table id="tbl_newOffering" runat="server" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td colspan="2" height="24" rowspan="3" width="19">
                            <img border="0" height="24" src="../images/lcurv.gif" width="19" /></td>
                        <td bgcolor="#6fb1d9" class="k" height="1" style="width: 600px">
                            <img border="0" height="1" src="../images/spacer(1).gif" width="100%" /></td>
                        <td align="right" colspan="2" height="24" rowspan="3" width="15">
                            <img border="0" height="24" src="../images/rcurv.gif" width="15" /></td>
                    </tr>
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" style="width: 600px">
                            <p align="center">
                                <b><font id="FONT1" color="#ffa500" face="Arial" size="2">Add New Course</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" style="width: 600px">
                    ...
                    <tr>
                        ...
                        <td bgcolor="white" height="114" width="18">
                            <img border="0" height="1" src="../images/spacer(1).gif" width="18" /></td>
                        <td bgcolor="#ffffff" height="114" style="width: 600px">
                            <div style="text-align: left">
                                <br />
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                    ...
                    <tr>
                        <td align="left" colspan="2" height="1" rowspan="2" valign="top" width="19">
                            <img border="0" height="15" src="../images/blcurv.gif" width="19" /></td>
                        <td bgcolor="white" height="1" style="width: 600px">
                            <img border="0" height="14" src="../images/spacer(1).gif" width="1" /></td>
                        <td align="right" colspan="2" height="1" rowspan="2" valign="top" width="15">
                            <img border="0" height="15" src="../images/brcurv.gif" width="15" /></td>
                    </tr>
