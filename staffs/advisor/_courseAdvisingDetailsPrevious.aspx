<%@ Page Language="C#" MasterPageFile="~/staffs/advisor/MasterPage_advisor.master" AutoEventWireup="true" CodeFile="_courseAdvisingDetailsPrevious.aspx.cs" Inherits="staffs_advisor_courseAdvisingDetailsPrevious"   %>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        ...
                                        <asp:Button ID="btn_final_offering" runat="server" OnClick="btn_final_offering_Click"
                                            Text="Finally Advising (& closing)" /></td>
                                </tr>
                            </table>
                            &nbsp;
                        </td>
