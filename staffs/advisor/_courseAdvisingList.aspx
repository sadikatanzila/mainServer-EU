<%@ Page Language="C#" MasterPageFile="~/staffs/advisor/MasterPage_advisor.master" AutoEventWireup="true" CodeFile="_courseAdvisingList.aspx.cs" Inherits="staffs_advisor_courseAdvisingList"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_tracker" Runat="Server">
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Advisoship &gt; Course Advising List</span></td>
        </tr>
    </table>
</asp:Content>
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="505">
                            <p align="center" style="text-align: center">
                                <b><font color="#ffa500" face="Arial" size="2">Course advising request list</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="505">
                            ...
                            <asp:GridView ID="GridView_advising" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="code" DataNavigateUrlFormatString="~/staffs/advisor/_courseAdvisingDetails.aspx?code={0}"
                                        DataTextField="SID" HeaderText="ID" NavigateUrl="~/staffs/advisor/_courseAdvisingDetails.aspx">
