<%@ Page Title="" Language="C#" MasterPageFile="~/staffs/advisor/MasterPage_advisor.master" AutoEventWireup="true" CodeFile="_courseReAdvisingDetailsP.aspx.cs" Inherits="staffs_advisor_courseReAdvisingDetailsP" %>
    ...
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Advisoship &gt; Course Re-Advising Details</span>
            </td>
        </tr>
    </table>
    <table border="0" cellpadding="2" cellspacing="0" width="90%">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <asp:Label ID="lbl_sid" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td style="text-align: left">
                <asp:Label ID="lbl_sName" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 20%; text-align: left">
            ...
            <td style="text-align: left">
                <asp:Label ID="lbl_program" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 20%; text-align: left">
            ...
            <td style="text-align: left">
                <asp:HyperLink ID="hplnk_academicStat" runat="server" Font-Bold="True">Academic Status</asp:HyperLink>
            </td>
        </tr>
    </table>
    &nbsp;
        ...
        <tr>
            <td colspan="3">
                <table id="tbl_offered_courses" runat="server" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="505">
                            <p align="center">
                                <b><font color="#ffa500" face="Arial" size="2">Courses Choosen</font></b></p></td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="505">
               ...
               <asp:TemplateField HeaderText="Course" >
                          ...
                          <HeaderStyle HorizontalAlign="left" />
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:Label ID="lbl_total_credit" runat="server" Font-Bold="True"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <td bgcolor="#6fb1d9" class="k" height="114" width="1">
                            <img border="0" height="1" src="../images/spacer(1).gif" width="1" />
                        </td>
                    </tr>
                    <tr>
                ...
                <table id="tbl_newOffering" runat="server" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" style="width: 505px">
                            <p align="center">
                                <b><font id="FONT1" color="#ffa500" face="Arial" size="2">Offer New Course</font></b></p></td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" style="width: 505px">
                            <img border="0" height="1" src="../images/spacer(1).gif" width="1" /></td>
                    ...
                    <tr>
                        ...
                        <td bgcolor="white" height="114" width="18">
                            <img border="0" height="1" src="../images/spacer(1).gif" width="18" />
                        </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btn_show" runat="server" OnClick="btn_show_Click" Text="Show" />&nbsp;<asp:Button
                                                ID="btn_prerequisit" runat="server" OnClick="btn_prerequisit_Click" Text="Prerequisite" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #0000ff">
                                            ...
                                            <asp:Label ID="lbl_advice" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Button ID="btn_add" runat="server" OnClick="btn_add_Click" Text="Add to Offering" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
