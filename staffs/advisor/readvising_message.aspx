<%@ Page Language="C#" MasterPageFile="~/staffs/advisor/MasterPage_advisor.master" AutoEventWireup="true" CodeFile="readvising_message.aspx.cs" Inherits="staffs_advisor_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_definition" Runat="Server">
    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="~/staffs/advisor/_courseReAdvisingList.aspx"><br></br>Click here to complete readvising others</asp:HyperLink><br />
    <br />
    <br />
    <br />
    <br />
