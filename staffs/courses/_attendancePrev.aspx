<%@ Page Language="C#" MasterPageFile="~/staffs/courses/_courses_master.master" AutoEventWireup="true" CodeFile="_attendancePrev.aspx.cs" Inherits="staffs_courses_attendancePrev" %>
                        ...
                        <td bgcolor="#ffffff" height="114" style="vertical-align: top; text-align: left"
                            width="505"><table style="width: auto">
                                <tr>
                                    ...
                                    <td style="width: auto;">
                                        <asp:TextBox ID="txt_date" runat="server" Width="150px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="width: auto">
                                        ...
                                        <asp:Button ID="btn_set_attendance" runat="server" OnClick="btn_set_attendance_Click" Text="Set Attendance" /></td>
                                </tr>
                            </table>
                            <br />
