<%@ Page Language="C#" MasterPageFile="~/staffs/courses/_courses_master.master" AutoEventWireup="true" CodeFile="_new_assignment.aspx.cs" Inherits="staffs_courses_new_assignment"  %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_tracker" Runat="Server">

<script type="text/javascript" language="javascript">
function loadCalenderOrd()
{
...
{ 
    ...
    else if(document.getElementById('ctl00_ContentPlaceHolder_content_txt_date').value=="")
    {
        alert("Please enter date.");
        return false;
    }
    else if(document.getElementById('ctl00_ContentPlaceHolder_content_fu_assignment').value=="")
    {
                        ...
                        <td align="left" bgcolor="#ffffff" height="114" width="505">
                            ...
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: aliceblue"><asp:Label ID="lbl_credit_hours" runat="server" Font-Bold="true"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td>Semester</td>
                                    <td><asp:Label ID="lbl_semester" runat="server" Font-Bold="true"></asp:Label></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Total Student</td>
                                    <td><asp:Label ID="lbl_total_student" runat="server" Font-Bold="true"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                            ...
                            <asp:GridView ID="GridView_assignment_list" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="COURSE_MATERIALS_ID" 
                                onrowdeleting="GridView_assignment_list_RowDeleting">
                                ...
                                <Columns>
                                 <asp:TemplateField Visible="false"> 
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="COURSE_MATERIALS_ID" DataNavigateUrlFormatString="~/staffs/courses/_downloadAssignment.aspx?code={0}"
                                        DataTextField="TITLE" HeaderText="Title" NavigateUrl="~/staffs/courses/_downloadAssignment.aspx" />
                                    <asp:BoundField DataField="up_date" HeaderText="Upload Date">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="sub_date" HeaderText="Due Date">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    
                                    <asp:TemplateField HeaderText="Delete" ItemStyle-Width="5%">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgButton" runat="server" ImageUrl="../../images/Delete.gif" CommandName="Delete"
                                   Width="25px" Height="25px" Text="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure to delete?')" />
                                    </ItemTemplate>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" style="float: left"
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="228">
                            <p align="center">
                                <font color="#ffa500"><b>Upload Assignment</b></font></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="228">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txt_date" runat="server" ></asp:TextBox>
                                     ...
                                     <!--   <img id="btn_calender" src="../../staffs/images/calender.jpg" style="height: 15px" runat="server" />-->
                                ...
                                <tr>
                                    <td>
                                        Attach file</td>
                                    <td><asp:FileUpload ID="fu_assignment" runat="server" Width="156px" /></td>
                                </tr>
                                <tr>
                                    <td>Comments</td>
                                    <td><textarea id="txt_comments" rows="2" style="width: 146px" runat="server"></textarea></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><asp:Button ID="btn_fupload_submit" runat="server" Text="Submit" OnClick="btn_fupload_submit_Click" /></td>
                                </tr>
                            </table>
                        </td>
