...
public partial class staffs_courses_attendanceReport : System.Web.UI.Page
{
    ...
    protected void Img1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ds.Rows.Count > 0)
        {
            ...
            crystalReport.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, Response, true, "AttendanceListdtlpdf");
