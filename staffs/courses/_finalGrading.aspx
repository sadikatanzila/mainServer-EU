<%@ Page Title="" Language="C#" MasterPageFile="~/staffs/courses/_courses_master.master" AutoEventWireup="true" CodeFile="_finalGrading.aspx.cs" 
    Inherits="staffs_courses_finalGrading" %>
 ...
 <script language="javascript" type="text/javascript">
  ...
  <script type="text/javascript">
      ...
      function EnableTextBoxValidation(objDDL) {
          ...
          var content = ddlDOM.id.substring(0, 45);
          var num = ddlDOM.id.substr(55);

          if (ddlDOM.selectedIndex > 0) {           

              if (ddlDOM.selectedIndex != 9) {
                  document.getElementById(content + "ddlstatus" + num).disabled = true;
                  //document.getElementById(ddlDOM.id.substring(0, 24) + "ddlstatus").disabled = true;
              }
              if (ddlDOM.selectedIndex == 9) {
                  document.getElementById(content + "ddlstatus" + num).disabled = false;
