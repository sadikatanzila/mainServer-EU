<%@ Page Language="C#" AutoEventWireup="true" CodeFile="class_routine.aspx.cs" Inherits="staffs_class_routine" %>
...
<body>
    ...
    <div>
        <div style="text-align: center">
            <asp:Label ID="lbl_title" runat="server" Font-Bold="True" Font-Size="Larger" Font-Underline="True"
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TOTAL_STUDENT" HeaderText="Total Student">
