<%@ Page Language="C#" MasterPageFile="~/staffs/Evaluation/MasterPage_Evaluation.master" AutoEventWireup="true" CodeFile="_course_teacherEvalSummery.aspx.cs" 
    Inherits="admin_course_teacherEvalSummery" Title="Untitled Page" %>
                                ...
                                <tr>
                                    <td class="header" style="height: 10px; background-color: #ffffff; text-align: left">
                                        ...
                                        <table id="Table1" runat="server" width="100%">
                                            ...
                                            <tr style="font-size: 8pt; color: #000000">
                                                <td>
                                                    <asp:Button ID="btn_show" runat="server" OnClick="btn_show_Click" Text="Show" Height="30px" Width="75px" />
                                          ...
                                          <asp:Panel ID="pnlTeacher" runat="server">
                                              ...
                                              <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" Text="Show"  Height="30px" Width="75px"/>
