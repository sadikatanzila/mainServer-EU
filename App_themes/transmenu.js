...
//==================================================================================================
//==================================================================================================
TransMenu.spacerGif = "images/px.gif";                     // path to a transparent spacer gif
TransMenu.dingbatOn = "arrows.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "images/px.gif";          // path to the inactive sub menu dingbat
...
TransMenu.shadowPng = "images/px.gif";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#f5f6f8";                   // color of the background (transparency set in CSS)
TransMenu.backgroundPng = "images/px.gif";          // a PNG graphic to server as the background for mac IE5
