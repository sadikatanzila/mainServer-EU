<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_rptDueList.aspx.cs" Inherits="employee_rptDueList" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Students' Due List</font></b> <hr />
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" style="vertical-align: top; text-align: left" width="100%">
                                    ...
                                    <td class="header" style="vertical-align: top; background-color: #ffffff; text-align: left">
                                        ...
                                        <span style="font-size: 10pt"><span style="color: #000000">
                                                    ...
                                                    <td style="width: auto; height: auto">
                                                      ...
                                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        Batch&nbsp;&nbsp;&nbsp;<span style="font-size: 10pt"><span style="color: #000000"><asp:TextBox ID="txtBatch" runat="server" MaxLength="4" Width="100px"></asp:TextBox>
                                        </span></span>
                                                    </td>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <tr>
                                                    <td class="auto-style1">
                                                        &nbsp;</td>
                                                    <td style="width: auto; height: auto">
                                                        <asp:RadioButton ID="rtbtnTotal" runat="server" GroupName="clstype" Text="Total"  Checked="true"  />
                                                        <asp:RadioButton ID="rbtnBatch" runat="server" GroupName="clstype" Text="Program-Batch wise"/>
                            ...
                            <asp:TemplateField HeaderText="SID" ItemStyle-Width="15%"> 
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="Contact" ItemStyle-Width="15%"> 
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="DUE" ItemStyle-Width="20%"> 
                                <ItemTemplate>
