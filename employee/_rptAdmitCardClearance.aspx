<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_rptAdmitCardClearance.aspx.cs" Inherits="employee_rptAdmitCardClearance" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Report on Admid Card Clearance</font></b> <hr />
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" style="vertical-align: top; text-align: left" width="100%">
                            ...
                            <asp:TemplateField HeaderText="SID" ItemStyle-Width="8%"> 
                                <ItemTemplate>
                           ...
                           <asp:TemplateField HeaderText="Sem Year" ItemStyle-Width="10%"> 
                             ...
                             <asp:TemplateField HeaderText="Exam Type" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Cleared by" ItemStyle-Width="12%"> 
                                <ItemTemplate>                               
                                     <asp:Label ID="lblSTAFF_NAME" runat="server" Text='<%# Bind("STAFF_NAME") %>'></asp:Label>  
                                    <br />
                                    (<asp:Label ID="lblINSERTIONID" runat="server" Text='<%# Bind("INSERTIONID") %>'></asp:Label>)                                     
                                </ItemTemplate>  
                            ...
                            <asp:TemplateField HeaderText="Cleared Time" ItemStyle-Width="15%"> 
                               ...
                               <asp:TemplateField HeaderText="Approval Dues" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblDUES" runat="server" Text='<%# Bind("APPROVAL_DUES") %>'></asp:Label>                                          
                                </ItemTemplate>  
                            </asp:TemplateField>  
                                                
                             <asp:TemplateField HeaderText="Current DUE" ItemStyle-Width="10%"> 
                                <ItemTemplate>
