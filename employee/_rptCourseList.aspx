<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_rptCourseList.aspx.cs" Inherits="employee_rptCourseList" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Report of Courses List</font></b> <hr />
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;</span></span></td>
                                                ...
                                                <tr>
                                                    <td class="auto-style1">
                                                        Department </td>
                                                    <td style="width: auto; height: auto">
                                                     <asp:DropDownList ID="ddlDepartment" runat="server" Height="16px" Width="150px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: auto; height: auto">
                                                        <span style="font-size: 10pt"><span style="color: #000000">
                                                                        <asp:Button ID="btn_submit" runat="server" OnClick="btn_submit_Click" Text="Course List" Width="116px" />
...
runat="server" onclick="Img1_Click" Visible="true"  />
    ...
    <span style="font-size: 10pt"><span style="color: #000000">
<asp:ImageButton ID="xcl" Height="50px" ImageUrl="~/Images/xcl.png"
runat="server" onclick="xcl_Click" Visible="true"  />                                                   
                                        </span>
