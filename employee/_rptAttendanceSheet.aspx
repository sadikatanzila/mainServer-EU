<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_rptAttendanceSheet.aspx.cs" Inherits="employee_rptAttendanceSheet" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Course wise Class Attendance Sheet</font></b> <hr />
                                                        ...
                                                        <asp:Panel ID="pnlCourse" runat="server" Visible="false">
                                                            <table style="width:95%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: auto; height: auto"><span style="font-size: 10pt"><span style="color: #000000">
                                                                        <asp:Button ID="btn_submit" runat="server" OnClick="btn_submit_Click" Text="Attendance Sheet" Width="149px" />
