<%@ Page Title="" Language="C#" MasterPageFile="~/employee/CommonStaffFacuty.master" AutoEventWireup="true" CodeFile="_rptAdmissionInquiry.aspx.cs" Inherits="employee_rptAdmissionInquiry" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="100%">
                    ...
                    <tr>
                        <td  class="h" height="22" width="100%">
                            <p align="center">
                                <b><font  face="Arial" size="2">Report on Admission Inquiry</font></b> <hr />
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" style="vertical-align: top; text-align: left" width="100%">
                           ...
                           <asp:TemplateField HeaderText="Sem Year" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Coming Date" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                                   <asp:Label ID="lblCOMINGDATE" runat="server" Text='<%# Eval("COMINGDATE", "{0:dd-MMM-yyyy}") %>'></asp:Label> 
                                      <asp:Label ID="lblCOMINGTIME" runat="server" Text='<%# Bind("COMINGTIME") %>'></asp:Label>                                         
                                </ItemTemplate>    
                            </asp:TemplateField>                   
                             

                          <asp:TemplateField HeaderText="Inserted by" ItemStyle-Width="10%"> 
                                <ItemTemplate>                               
                                     <asp:Label ID="lblInsSTAFF_NAME" runat="server" Text='<%# Bind("InsertedBy") %>'></asp:Label>  
                                    <br />
                                    (<asp:Label ID="lblINSERTIONID" runat="server" Text='<%# Bind("INSERTED_BY") %>'></asp:Label>)                                     
                                </ItemTemplate>  
                              <ItemStyle VerticalAlign="NotSet" HorizontalAlign="Center" />
                            </asp:TemplateField>
     

                           <asp:TemplateField HeaderText="Insertion Time" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                                   <asp:Label ID="lblINSERTIONDATE" runat="server" Text='<%# Eval("INSERTIONDATE", "{0:dd-MMM-yyyy}") %>'></asp:Label>  
                                      <asp:Label ID="lblINSERTIONTIME" runat="server" Text='<%# Bind("INSERTIONTIME") %>'></asp:Label>                                         
                                </ItemTemplate>  
                            </asp:TemplateField> 

                               <asp:TemplateField HeaderText="Updated by" ItemStyle-Width="10%"> 
                                <ItemTemplate>                               
                                     <asp:Label ID="lblSTAFF_NAME" runat="server" Text='<%# Bind("UpdatedStaff") %>'></asp:Label>  
                                    <br />
                                    (<asp:Label ID="lblUPDATEDID" runat="server" Text='<%# Bind("UPDATED_BY") %>'></asp:Label>)                                     
                                </ItemTemplate>  
                              <ItemStyle VerticalAlign="NotSet" HorizontalAlign="Center" />
                            </asp:TemplateField>

                                               
                         <asp:TemplateField HeaderText="Updated Time" ItemStyle-Width="10%"> 
                                <ItemTemplate>
                                   <asp:Label ID="lblUPDATINGDATE" runat="server" Text='<%# Eval("UPDATEDDATE", "{0:dd-MMM-yyyy}") %>'></asp:Label>   
                                      <asp:Label ID="lblUPDATINGTIME" runat="server" Text='<%# Bind("UPDATEDTIME") %>'></asp:Label>                                         
                                </ItemTemplate>  
                            </asp:TemplateField>                                                            
                                            </Columns>
