<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_EUAnniversayOnlinePayment.aspx.cs" Inherits="Convocation_EUAnniversayOnlinePayment" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
   <title>15th Year Celebration - Online Payment</title>
    ...
    <b>:</b>
                                ...
                                <tr>
                                    ...
                                    <td style="height: 20px">
                                        &nbsp;</td>
                                    <td style="height: 20px; width: 84px">
                                        <strong>Registration Fee</strong></td>
                                    <td style="height: 20px">
                                        :</td>
                                    <td style="height: 20px">
                                        <asp:Label ID="lblRegFee" runat="server" Text=""></asp:Label>
                      ...
                      <br />
                       ...
                       <br />
                         ...
                         <asp:TextBox ID="txtVourcher" runat="server" Width="125px" style="margin-left:5px" Visible="false"></asp:TextBox>
                          ...
                          <br />
                          <asp:Button ID="Button1" runat="server" Text="Check Payment" Font-Bold="True" OnClick="Button1_Click"  Visible="true"/>
                          </td>
                            ...
                            <asp:Panel ID="pnlCong" runat="server" style="text-align:center" ForeColor="Blue" Visible="false">
                                ...
                                <br />
                                  ...
                                  <asp:Label ID="Label2" runat="server" Text="Your Registration for 5th Convocation has been completed Sucessfully"></asp:Label>
                            </asp:Panel>
                        </td>
