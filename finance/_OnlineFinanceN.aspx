<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_OnlineFinanceN.aspx.cs" 
Inherits="student_finance_OnlineFinance" EnableEventValidation="false" %>
                  ...
                  <table border="0" style=" float:left;" cellpadding="0" cellspacing="0" height="1" width="162">
                      ...
                      <tr>
                          ...
                          <td align="left" bgcolor="#ffffff" height="63" valign="top" style="width: 228px">
                              ...
                              <br />
                              &gt;<a href="_OnlineFinance.aspx">Online Payment</a><br />
                              </td>
...
<asp:Panel ID="pnlStdAmount" runat="server" >
     ...
     <HeaderStyle ForeColor="#804000" />
           ...
           <asp:TemplateField HeaderText="Particulars" SortExpression="Particulars">
                        ...
                        <asp:TemplateField HeaderText="Amount" SortExpression="Amount">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="Amount" runat="server" Text='<%# Bind("amount") %>' Width="80px" 
...
<asp:TemplateField HeaderText="Amount dtl"  SortExpression="Amount dtl" Visible="false">
    <ItemTemplate>
    <asp:TextBox ID="txtamount" runat="server" 
                 Text='<%# Bind("amount") %>' ReadOnly="true" 
