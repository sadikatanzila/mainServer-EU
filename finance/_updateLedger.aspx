<%@ Page Language="C#" MasterPageFile="~/student/finance/finance_masterPage.master" AutoEventWireup="true" CodeFile="_updateLedger.aspx.cs" Inherits="student_finance_updateLedger" Title="Update Ledger" %>
    ...
    <table border="0" style="text-align: left">
        <tr>
            <td colspan="3" style="text-align: left">
                <span style="color: #ffa500">Your location- Finance&gt;Update Ledger</span></td>
        </tr>
    </table>
</asp:Content>
                ...
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="539">
                    ...
                    <tr>
                        <td bgcolor="#eef5fa" class="h" height="22" width="505">
                            <p align="center">
                                <b><font color="#ffa500" face="Arial" size="2">Update Student Ledger</font></b></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#6fb1d9" class="k" height="1" width="505">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#ffffff" height="114" width="505" valign="top" align="left" >
                            <br />
                            &nbsp;&nbsp;
                            <asp:Button ID="btn_submit" runat="server" Text="Update Ledger" 
                            Enabled="false" Font-Bold="true"
                                Height="31px" Width="144px" onclick="btn_submit_Click"/>&nbsp;
                                <br /> <br /> <br />
