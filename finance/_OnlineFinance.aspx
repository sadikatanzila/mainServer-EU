<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_OnlineFinance.aspx.cs" 
            ...
            <td colspan="3">
                <table border="0" cellpadding="0" cellspacing="0" height="1" width="98%" 
                    ...
                    <tr>
                        <td  width="505">
                            <p align="center">
                                <b><font color="#ffa500" face="Arial" size="2">Student Online Payment</font></b></p>
                                <hr />
                        </td>
                    </tr>
                    <tr>
    ...
    <table style="width:60%; text-align: left; margin-left:40%">
        <tr>
            <td class="auto-style1" colspan="3">
                <strong>Deatil of Registration Fees taka 7000/-
                <br />
                <br />
