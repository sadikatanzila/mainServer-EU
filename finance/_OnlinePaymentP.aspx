<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_OnlinePaymentP.aspx.cs" 
Inherits="student_finance_OnlinePaymentP" EnableEventValidation="false"  %>
...
<asp:Label ID="lbl_message" runat="server" Font-Size="X-Small" ForeColor="Red" Text="To Pay Your Payment with Online Payment, Press 'Pay Now'."></asp:Label>
   ...
   <form id="payment_gw" name="payment_gw" >
    ...
    <input type="hidden" name="tran_id" value="578e05a14579e" id="tran_id" runat="server"/>
    
    <input type="hidden" name="cus_name" value="ABC XYZ" id="cus_name" runat="server">
    <input type="hidden" name="cus_email" value="abc.xyz@mail.com" id="cus_email" runat="server">
    <input type="hidden" name="cus_phone" value="01111111111" id="cus_phone" runat="server">
