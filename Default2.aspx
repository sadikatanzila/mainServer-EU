...
<script language="javascript" type="text/javascript" for="OBJECT2" event="onclick">
// <!CDATA[
return OBJECT2_onclick()
// ]]>
</script>
</head>
<body style="margin-top:0; margin:0; font-size: 12pt;">
    <form id="form1" runat="server">
            ...
            <tr>
                <td rowspan="15">
                    <img alt="" name="eu_cect" src="images1/eu_cect.jpg"
                      ? style="height: 593px; width: 28px" /></td>
                ...
                <td rowspan="15">
                    <img alt="" name="dots" src="images1/dots.jpg"
                        width="19" style="height: 586px" /></td>
            ...
            <tr style="font-family: Times New Roman">
                <td>
                    <a href="general/Miscellaneous/_officials.aspx" >
                        <img alt="Faculty & Staff" border="0" name="faculty_button" src="images1/faculty-button.jpg"
                            width="175" style="height: 24px" /></a></td>
				...
				<td class="style2" align="center">				
                                <a style="font-weight:bold; color:Red; text-align: center" href= "./AdmisionResult/BBAResultFinal.pdf"> BBA</a></td>
				<td class="header" align="right">
                                &nbsp;</td>
				...
				<td class="style2" align="center">				
                                <a style="font-weight:bold; color:Red; text-align: center" href= "./AdmisionResult/Test Result-1 Sum'10(Engineering).pdf">E&amp;T</a></td>
				<td class="header" align="right">
                                &nbsp;</td>
				...
				<td class="style2" align="center">				
                                <a style="font-weight:bold; color:Red; text-align: center" href= "./AdmisionResult/Test Result-1 Sum'10(English).pdf">English</a></td>
				<td class="header" align="right">
                                &nbsp;</td>
				...
				<td class="style2" align="center">				
                                <a style="font-weight:bold; color:Red; text-align: center" href= "./AdmisionResult/Test Result-1 Sum'10(Law).pdf">Law</a></td>
				<td class="header" align="right">
                                &nbsp;</td>
                    ...
                    <table>
                    <tr>
                      <td align="center" style="vertical-align:middle;" class="style4">                      
                                               
                            <%--<object id="OBJECT2" style="POSITION: static; HEIGHT: 91px; width: 129px;"                         
                                codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,115,0"  
                                classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
                        <param NAME="banner" VALUE="images1/7thFoundationDay2010.swf" />
                        <PARAM NAME="movie" VALUE="images1/7thFoundationDay2010.swf"/>
                        <PARAM NAME="quality" VALUE="high"/>
                        <param name="FlashVars" value=""/>
                        <param name="WMode" value="Window"/>
                        <param name="Play" value="1"/>
        ...
        <embed src="video-filename.swf" width="129" height="91" play="true" loop="false" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer"
        type="application/x-shockwave-flash">
        </embed>
        </object> --%>
        
        <a href="advertise.aspx" > 
        <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="129" height="91" id="pics" align="middle">
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="false" />
                    <param name="movie" value="images1/7thFoundationDay2010.swf" /><param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />	
                    <embed src="images1/7thFoundationDay2010.swf" quality="high" bgcolor="#ffffff" width="129" height="91" name="pics" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
                    </object>
                  More
                      </a>                      
                      </td>
            ...
            <tr>
                <td rowspan="2">
                    <a href="general/Miscellaneous/_student.aspx">
                        <img alt="Student" border="0" name="Students" src="images1/eu_students.jpg"
                            width="175" style="height: 22px" /></a></td>
                <td>
                    <img alt="" height="14" src="images1/spacer.gif"
                        width="1" /></td>
            </tr>
            ...
            <tr>
                <td>
                    <a href="#"  >
                        <img alt="Career" border="0" name="Career" src="images1/eu_career.jpg"
                            width="175" style="height: 27px" /></a></td>
                <td>
                    <img alt="" height="25" src="images1/spacer.gif"
                        width="1" /></td>
            </tr>
            <tr>
                <td rowspan="2">
                        ...
                        <img alt="" border="0" name="" src="images1/Community-button.jpg"
                            width="175" style="height: 46px" /></a></td>
                <td>
            ...
            <tr>
                <td rowspan="7">
                    <img alt="" border="0" height="430" name="left_llog" src="images1/left_llog.jpg"
       ...
       ?                width="1" /></td>
        ...
        <map id="asd" name="left_llog">
            <area coords="22, 69, 118, 91"  href="student/_login.aspx" shape="RECT"
                target="_self" />
            <area coords="22, 102, 120, 123"  href="staffs/_login.aspx" shape="RECT"
                target="_self" />
        </map>
